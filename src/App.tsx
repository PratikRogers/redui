  ...
  static propTypes = {
   ...
   constructor(props: any) {
     ...
     this.allRoutes = [
       ...
       {path: '/reduiCRMUploader', component: CRMUploaderFormComponent}
     ];
     ...
     // <IntlProvider locale={this.language} messages={this.localizationMessages[this.language]}>
       <div className="redUI">
         ...
         {/* <RedUISpinner UIConfStats={spinnerState} /> */}
         {
           ...
           //    </Route> :
           // <AccessError />
           //  <p>This is custom message for testing contadct to developer</p>
         }
         {/* <MessageBox /> */}
         {/* <BottomPanelBar /> */}
         {/* </BrowserRouter> */}
...
export default flow(connect(mapStateToProps, (dispatch) => {
  return {
